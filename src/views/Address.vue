  ...
  <div class="container">
    <div class="checkout-addr">
      ...
      <div class="addr-list-wrap">
        <div class="addr-list">
          <ul>
            <li v-for="(item, index) in addressListFilter" v-bind:class="{'check': index == checkIndex}" @click="checkIndex = index; selectedAddrId = item.addressId">
              <dl>
                <dt>{{item.userName}}</dt>
        ...
        <div class="shipping-addr-more">
          <a class="addr-more-btn up-down-btn" href="javascript:;" @click="expend" v-bind:class="{'open': this.limit>3}">
            more
            <i class="i-up-down">
...
<modal :mdShow="isMdShow" @close="closeModal">
    ...
    <a class="btn btn--m" href="javascript:;" @click="isMdShow=flase">取消</a>
	</div>
</modal>
